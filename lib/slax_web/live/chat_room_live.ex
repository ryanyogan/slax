defmodule SlaxWeb.ChatRoomLive do
  ...
  def render(assigns) do
    ...
    <div class="flex flex-col flex-grow shadow-lg">
      ...
      <div class="flex flex-col flex-grow overflow-auto" id="room-messages" phx-update="stream">
  ...
  def message(assigns) do
    ~H"""
    <div class="relative flex px-4 py-3" id={@dom_id}>
      ...
      <div class="ml-2">
        <div class="-mt-1">
          ...
          <span class="ml-1 text-xs text-gray-500"><%= message_timestmp(@message) %></span>
  ...
  defp message_timestmp(message) do
    message.inserted_at
